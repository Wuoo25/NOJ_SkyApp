package com.example.mywork10.Utils.ViewPager;
...
public class VerticalTabLayout extends ScrollView {
    ...
    public VerticalTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mIndicatorWidth = (int) typedArray.getDimension(q.rorbin.verticaltablayout.R.styleable.VerticalTabLayout_indicator_width, DisplayUtil.dp2px(context, 0));
        mIndicatorHeight = (int) typedArray.getDimension(q.rorbin.verticaltablayout.R.styleable.VerticalTabLayout_indicator_color, DisplayUtil.dp2px(context, 0));
    ...
    /*public void ungradeTabback(int position) {
        for (int i = 0; i < mTabStrip.getChildCount(); i++) {
            ...
            view.setBackground(q.rorbin.verticaltablayout.R.drawable.man_01_none);
            if (i == position) {
                view.setBackground(q.rorbin.verticaltablayout.R.drawable.man_02_none);
            }
            if (i == position - 1) {
                view.setBackground(q.rorbin.verticaltablayout.R.drawable.man_03_none);
            }

            if (i == position + 1) {
                view.setBackground(q.rorbin.verticaltablayout.R.drawable.man_04_none);
            }
    ...
    /*public void setTabBadge(int tabP osition, int badgeNum) {
...
*/
    ...
    private class TabStrip extends LinearLayout {
        ...
        protected void onDraw(Canvas canvas) {
           ...
           // Drawable drawable = getResources().getDrawable(R.drawable.ic_right_24);
            Rect rect = new Rect();
            rect.left = (int) mIndicatorX;
           int  height = (int) (mIndicatorBottomY - mIndicatorTopY);
            rect.top = (int) mIndicatorTopY + height / 3;
            rect.right = (int) (mIndicatorX + mIndicatorWidth);
            rect.bottom = (int) mIndicatorBottomY - height / 3;
            ...
            mIndicatorRect.top = mIndicatorTopY + 8;
            mIndicatorRect.right = mIndicatorX + 28;
            mIndicatorRect.bottom = mIndicatorBottomY + 8;

            mIndicator_before_Rect.set(rect);

            if (mIndicatorCorners != 0) {
                canvas.drawRoundRect(mIndicator_before_Rect, 10, 10, mIndicatorPaint);
                canvas.drawRoundRect(mIndicatorRect, 10, 10, mIndicatorPaint);
            } else {
