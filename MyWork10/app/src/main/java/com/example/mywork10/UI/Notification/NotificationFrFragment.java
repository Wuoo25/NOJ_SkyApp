 ...
 * 初级教学页面
 */
public class NotificationFrFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        //fragment页面绘制
        View view = inflater.inflate(R.layout.fragment_fr_notifi, container, false);
        //将getList的列表全部添加到List中
        super.onCreate(savedInstanceState);

        notiBeanList= NotiDao.getListFr();
        mRecycler=view.findViewById(R.id.notification_fr_recycler);
