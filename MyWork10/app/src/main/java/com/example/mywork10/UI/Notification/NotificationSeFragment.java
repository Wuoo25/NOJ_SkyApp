 ...
 * 中级教学页面
 */
public class NotificationSeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        //fragment页面绘制
        View view = inflater.inflate(R.layout.fragment_se_notifi, container, false);
        super.onCreate(savedInstanceState);

        notiBeanList= NotiDao.getListTh();
        mRecycler=view.findViewById(R.id.notification_Se_recycler);
